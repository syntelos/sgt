...
public abstract class SoTRange implements java.io.Serializable, Cloneable {
   ...
   * <code>GeoDate</code>.
   * @since sgt 2.0
   * @deprecated As of sgt 3.0, replaced by {@link sgt.util.SoTRange.Time SoTRange.Time}
   */
  public static class GeoDate extends SoTRange {
    /** The range's first time  */
    public sgt.util.GeoDate start = null;
    /** The range's last time  */
    public sgt.util.GeoDate end = null;
    /** The range's time increment  */
    public sgt.util.GeoDate delta = null;
    /**
     ...
     */
    public GeoDate(sgt.util.GeoDate tstart,
       sgt.util.GeoDate tend) {
    ...
    public GeoDate(TimeRange trange) {
      start = new sgt.util.GeoDate(trange.start.getTime());
      end = new sgt.util.GeoDate(trange.end.getTime());
      if(trange.delta != null) {
        delta = new sgt.util.GeoDate(trange.delta.getTime());
      } else {
        delta = null;
      }
    }
    ...
    public SoTRange copy() {
      sgt.util.GeoDate cStart = null;
      sgt.util.GeoDate cEnd = null;
      sgt.util.GeoDate cDelta = null;
      if(start != null)
        cStart = new sgt.util.GeoDate(start.getTime());
      if(end != null)
        cEnd = new sgt.util.GeoDate(end.getTime());
      if(delta != null)
        cDelta = new sgt.util.GeoDate(delta.getTime());
  ...
  public static class Time extends SoTRange {
    ...
    public Time(sgt.util.GeoDate ustart,
                sgt.util.GeoDate uend) {
