...
public abstract class SoTValue implements Serializable {
   ...
   * <code>GeoDate</code>.
   * @since sgt 2.0
   * @deprecated As of sgt 3.0, replaced by {@link sgt.util.SoTValue.Time SoTValue.Time}
   */
  public static class GeoDate extends SoTValue {
    sgt.util.GeoDate date_;
    /**
     * Default constructor.
     */
    public GeoDate() {}
     ...
     */
    public GeoDate(sgt.util.GeoDate date) {
      date_ = date;
    }
    /**
    ...
    public GeoDate(long time) {
      this(new sgt.util.GeoDate(time));
    }
    /**
     * Get the value
     */
    public sgt.util.GeoDate getValue() {
      return date_;
    }
    /**
     * Set the value from a <code>GeoDate</code>
     */
    public void setValue(sgt.util.GeoDate date) {
      date_ = date;
    }
    /**
    ...
    public void setValue(long time) {
      date_ = new sgt.util.GeoDate(time);
    }
     ...
     * @since 3.0
     */
    public sgt.util.GeoDate getGeoDate() {
      return new sgt.util.GeoDate(date_);
    }
  ...
  public static class Time extends SoTValue {
    ...
    public Time(sgt.util.GeoDate value) {
     ...
     */
    public sgt.util.GeoDate getGeoDate() {
      return new sgt.util.GeoDate(value_);
    }
...
//      return java.lang.Long.toString(value_);
  ...
  public abstract sgt.util.GeoDate getGeoDate();
