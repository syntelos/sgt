...
//        panel.setBorder(new EtchedBorder());
   ...
   * @see sgt.sgt.AbstractPane#DEFAULT_SCALE AbstractPane.DEFAULT_SCALE
   * @see sgt.sgt.AbstractPane#TO_FIT AbstractPane.TO_FIT
   * @see sgt.sgt.AbstractPane#SHRINK_TO_FIT AbstractPane.SHRINK_TO_FIT
   */
   ...
   * @see sgt.sgt.AbstractPane#TOP AbstractPane.TOP
   * @see sgt.sgt.AbstractPane#MIDDLE AbstractPane.MIDDLE
   * @see sgt.sgt.AbstractPane#BOTTOM AbstractPane.BOTTOM
   * @see sgt.sgt.AbstractPane#SPECIFIED_LOCATION AbstractPane.SPECIFIED_LOCATION
   */
   ...
   * @see sgt.sgt.AbstractPane#LEFT AbstractPane.LEFT
   * @see sgt.sgt.AbstractPane#CENTER AbstractPane.CENTER
   * @see sgt.sgt.AbstractPane#RIGHT AbstractPane.RIGHT
   * @see sgt.sgt.AbstractPane#SPECIFIED_LOCATION AbstractPane.SPECIFIED_LOCATION
   */
   ...
   * @see sgt.sgt.AbstractPane AbstractPane
   */
